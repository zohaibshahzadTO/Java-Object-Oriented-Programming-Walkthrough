...
public class Overload {
  ...
  // Just that we have an inheritance hierarchy to use as a parameter
  ...
  public static void main(String[] args) {
    ...
    // is also resolved at runtime based on the argument object types. Java
    // resolves all overloading at compile time when objects do not exist.
